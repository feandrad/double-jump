package io.felipeandrade.doublejump.network;
...
public class JumpPacketHandler implements PlayChannelHandler {
    ...
    public static void sendJumpPacket(PlayerEntity player) {
        ServerPlayNetworking.send((ServerPlayerEntity) player, new Identifier("doublejump", "jump"), new PacketByteBuf(Unpooled.buffer()));
    }
}
